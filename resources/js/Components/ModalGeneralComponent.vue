<template>
    <div>
        <VueFinalModal v-model="show" @before-close="hideCreateModal()">
            <div class="modal modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div
                        class="modal-body scroll-y pt-0 pb-20 px-lg-10 bg-white"
                        style="
                            min-height: 65vh;
                            max-height: 85vh;
                            overflow-y: auto;
 ...
 * Props & Emits
 */
const props = defineProps(["show", "edit", "delete", "title", "closeModal"]);
