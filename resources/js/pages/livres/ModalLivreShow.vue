<template>
    <ModalGeneralComponent :title="' '" :closeModal="close_modal">
        <loading-card-overlay :loading="loading" custom_class="card card-flush">
            <div class="">
                <div class="flex-sm-nowrap" v-if="!loading">
                    <div class="d-lg-flex justify-content-between">
                        ...
                        <div class="col-12 col-lg-6 ms-6 mt-5 mt-lg-0">
                            <h1
                                class="text-gray-900 text-hover-primary fs-1 fw-bold"
                            >
                                {{ livre.titre }}
                            </h1>
                            ...
                            <div class="d-flex flex-wrap col-8">
                                <small
                                    class="text-gray-400 mb-2 col-12 fs-6 align"
                                >
                                    <i
                                        class="fas fa-book me-1 text-dark fs-5"
                                    ></i>
                                    Type de roman
                                </small>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="col-12 pb-6">
                            <h1
                                class="fw-bold fs-2 text-gray-600 mb-7 text-center"
                            >
                                Synopsis
                            </h1>
                            <div
